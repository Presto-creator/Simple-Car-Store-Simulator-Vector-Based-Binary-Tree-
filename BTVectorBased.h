...
//	Position last() { VectorTree<E>::Position temp; temp = pos(size()); return *temp; }
//	Position last() const { return pos(V.size() - 1); }
	Position last()  { return pos(size()); }
	
//	VectorTree<E>::Position last() const { return pos(size()); }
	//VectorTree<E>::Position getLast() { return &last(); }
	//VectorTree<E>::Position getRoot() const { return &root(); }
	void clear()
	{
		V.clear();
		V.push_back("");
